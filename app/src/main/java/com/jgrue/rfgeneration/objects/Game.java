...
public class Game {
	...
	private Drawable getRegionDrawable(Context context, String region) {
		if(regionMap == null) {
			...
			regionMap.put("CZ", context.getResources().getDrawable(R.drawable.regions_cz));
			...
			regionMap.put("GR", context.getResources().getDrawable(R.drawable.regions_gr));
			...
			regionMap.put("HU", context.getResources().getDrawable(R.drawable.regions_hu));
			...
			regionMap.put("IS", context.getResources().getDrawable(R.drawable.regions_is));
			...
			regionMap.put("MX", context.getResources().getDrawable(R.drawable.regions_mx));
			regionMap.put("MY", context.getResources().getDrawable(R.drawable.regions_my));
			...
			regionMap.put("RU", context.getResources().getDrawable(R.drawable.regions_ru));
			regionMap.put("SE", context.getResources().getDrawable(R.drawable.regions_se));
			regionMap.put("SG", context.getResources().getDrawable(R.drawable.regions_sg));
			regionMap.put("SK", context.getResources().getDrawable(R.drawable.regions_sk));
			...
			regionMap.put("Z", context.getResources().getDrawable(R.drawable.regions_z));
			regionMap.put("ZA", context.getResources().getDrawable(R.drawable.regions_za));
		}
